...
if(distributionType != 40){
        ...
        $.ajax({
                ...
                success:function(data){
                    ...
                    $.each(data.data.list,function(i,item){
                       	...
                       	<td>"+isNotNullAndUndifine(item.profitCustomerDownRateStr)+"</td>\
   ...
   function allmoney(){
	   $.ajax({
	        ...
	        success:function(data){
	        	$(".allmoney").text(data.data.profitSumStr);	
   ...
   $(".saiuse").click(function(){
    ...
    $(".findEver").on("click",function(){
    	...
    	$(".table1 tbody").html("");
    	$(".pages-size").html("");
    	pageStart(1,10,topCustomerId,applyCustomerId,dateBegin,dateEnd);
    })
