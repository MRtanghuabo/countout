                        ...
                        <div class="del_shaow">
                            ...
                            <div class="ever_text">
								<table>
                                    ...
                                    <tr>
                                        <td>打款方式：<p class="paymentType"></p></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>代征主体费率：<p class="dzztfv"></p></td>
                                       
                                    </tr>
                                    <tr>
                                        <td>公司手续费：<p class="copfv"></p></td>
                                        
                                    </tr>
                                    <tr>
                                        <td>BD人员提成比例：<p class="bdRa"></p></td>
                                       
                                    </tr>
                                    <tr>
                                    	<td>总服务费：<p class="allRa"></p></td>
                                    </tr>
                                    <tr class="line">
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td style="color:#FFC245;">人员信息</td>
                                    </tr>
                                    <tr>
                                        <td>BD人员：<p class="BDcall"></p></td>
...
<script>
    ...
    var pagestars=1;
     ...
     $(".next-btn").on("click",function(){
    	...
    	parentCustomerId=$(".parentsCHo").val();
    	pageStart(pagestars,10,orgPassid,substitutedCollectionId,dateBegin,dateEnd,parentCustomerId);
     	return pagestars
     })
    ...
    function pageStart(pageNum,pageSize,orgPassid,substitutedCollectionId,dateBegin,dateEnd,parentCustomerId){
        ...
        $.ajax({
                ...
                data:JSON.stringify({"substitutedCollectionId":substitutedCollectionId,"mainCustomerId":orgPassid,"dateBegin":dateBegin,"dateEnd":dateEnd,"pageNum":pageNum,"pageSize":pageSize,"parentCustomerId":parentCustomerId}),
                success:function(data){
                    ...
                    $.each(data.data.list,function(i,item){
                        ...
                        var textDisable = ""; 
                        if(distributionType == 40){
                        	textOption = "<a class='showall' data-index="+item.customerId+" href='javascript:;'>查看</a>&nbsp;<a href='newShopcreat.jsp?"+item.customerId+"'>修改</a>&nbsp;<a data-index="+item.customerId+" class='dels' href='javascript:;'>删除</a>";
                        ...
                        if(item.paymentType=='0'){
                       	...
                       	<td>"+isNotNullAndUndifine(item.parentCustomerName)+"</td>\
                       	...
                       	<td>"+isNotNullAndUndifine(item.profitRateStr)+"%</td>\
   ...
   //显示代征主体下拉框数据
	   $.ajax({
          ...
          success:function(data){
          	...
          	$.each(data.data,function(i,item){
          		str="<option value="+item.substitutedCollectionId+">"+isNotNullAndUndifine(item.substitutedCollectionName)+"</option>";
          		$(".dzzt").append(str);
          	})
    ...
    $(".findEver").on("click",function(){
    	...
    	$(".table1 tbody").html("");
    	$(".pages-size").html("");
    	pageStart(1,10,orgPassid,substitutedCollectionId,dateBegin,dateEnd,parentCustomerId);
    })
  ...
  $(".newShop").click(function(){
	  window.location="newShopcreat.jsp";
  })
	  ...
	  customerId=$(this).attr("data-index");
	  	$.ajax({
	  		...
	  		success:function(data){
	  			...
	  			$(".dzztfv").text(isNotNullAndUndifine(data.data.substitutedCollectionRateStr)+"%");
	  			$(".copfv").text(isNotNullAndUndifine(data.data.profitRateStr)+"%");
	  			$(".bdRa").text(isNotNullAndUndifine(data.data.salesmanRateStr)+"%");
	  			$(".allRa").text(isNotNullAndUndifine(data.data.poundageStr)+"%");
	  			$(".BDcall").text(isNotNullAndUndifine(data.data.salesmanName));
