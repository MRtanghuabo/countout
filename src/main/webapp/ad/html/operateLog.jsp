            ...
            <div class="right_dal">
                ...
                <div class="shop_list_f_form">
                    <div class="_input" style="overflow:hidden">
					   ...
					   <ul>
	                       <li>商户名称：</li>
	                       <li><input id="customerName" class="username" type="text"/></li>
	                   </ul>
...
var orgPassid="<%=UserHolder.getOrgId()%>";
    ...
    function pageStart(pageNum,pageSize,customerId,customerName,dateBegin,dateEnd){
		...
		if(customerName){}else{distributionType=""}
        ...
        $.ajax({
                ...
                contentType: "application/json;charset=utf-8",
                data:JSON.stringify({"customerId":customerId,"customerName":customerName,"dateBegin":dateBegin,"dateEnd":dateEnd,"pageNum":pageNum,"pageSize":pageSize}),
                success:function(data){
