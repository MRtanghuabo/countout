	...
	<div class="shop_wrap">
		...
		<div style="height: 100%;" class="shopList_wrap">
			...
			<div class="right_dal">
				...
				<p class="shop_list_f add_invoices">修改发票</p>
...
$.ajax({
    ...
    data:JSON.stringify({"invoiceId":urlArr2[1]}),
    success:function(data){
    	console.log(data);
    	$(".invoiceSumStr").val(isNotNullAndUndifine(data.data.invoiceSumStr))
    	...
    	$(".payInvoice").attr("data-index",isNotNullAndUndifine(data.data.rechargeId))
